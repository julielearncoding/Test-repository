...
public class HAS001_001_Holiday_Activities_Search_Only extends SetupAndTearDown {

	@Test(dataProvider = "HAS001_003")
	public void HAS001_003_searchActivities(String destination, String from, String to) {
	...
	@DataProvider(name = "HAS001_003")
	public Object[][] searchData() {
		return new Object[][] { { "Ho Chi Minh", "27/03/2020","29/03/2020" } };
	}
}
