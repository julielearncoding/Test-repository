...
public class NT001_LoginUnSuccessfully_WrongUsername extends SetupAndTearDown {

	@Test(dataProvider = "NT001_001")
	public void NT001_001_LoginUnSuccessfully(String username, String password, String expectedPageTitle) {
	...
	public Object[][] searchData() {
		return new Object[][]  {{ "shopee", "Shopee@2020", "Sign-on: Mercury Tours" }};
	}
}