...
public class NT001_LoginSuccessfully extends SetupAndTearDown {

	@Test(dataProvider = "NT001_001")
	public void NT001_001_LoginSuccessfully(String username, String password, String expectedPageTitle) {
	...
	public Object[][] searchData() {
		return new Object[][]  {{ "shopeetest", "Shopee@2020", "Find a Flight: Mercury Tours:" }};
	}
}